 ...
 * @author Henry
 */
public class TableroGF extends javax.swing.JFrame {

    /**
     * Creates new form TableroGF
     */
    ...
    private void initComponents() {
        ...
        jLabel4.setText("HENRY GLOBER GOMEZ FLORES");
    ...
    public void Evaluar(MaquinaGF m){
        if(m.eval(this)==-1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableroGF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
