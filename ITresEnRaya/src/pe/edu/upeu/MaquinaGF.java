...
import pe.edu.upeu.TableroGF;



public class MaquinaGF
{
  public int NivelDios(int modo, TableroGF ta)
  {
  ...
  public int NivelNormal(int iteraciones, int modo, TableroGF ta){
    int mflocal = 0; int mclocal = 0;
    int valor = eval(ta);
  ...
  public int NivelFacil(int iteraciones, int modo, TableroGF ta){
      int mflocal = 0; int mclocal = 0;
    int valor = eval(ta);
